...
<script setup lang="ts">
  ...
  const emits = defineEmits<{
    <T extends UiSelectData | UiSelectData[]>(name: 'updateValue', val: T): void
  }>()
  ...
  const selectValue = ref(props.options?.checkedList ?? (props.options?.multiple ? [] as UiSelectData[] : {} as UiSelectData))
  ...
  $listen('reset', () => {
    selectValue.value = props.options?.checkedList ?? (props.options?.multiple ? [] : {} as UiSelectData)
  })
  ...
  .UiSelect {
    ...
    :deep() .el-select {
        ...
        .el-select__selected-item {
          ...
          .el-tag {
            ...
            i {
              margin: 0;
              color: $black;
              transition: background-color $minTime, color $minTime;
            }
          }
        }
      }
      &__wrapper {
        ...
        transition: border-color $minTime;
        border-radius: 0;
        background-color: transparent;
