...
<style scoped lang="scss">
  .UiUpload {
    transition: row-gap $minTime;
    &.active {}
    .__item {
      transition: padding-right $minTime, background-color $minTime;
