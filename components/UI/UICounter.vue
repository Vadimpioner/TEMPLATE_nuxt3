<template>
  <div class="UICounter d-flex fd-c">
    ...
    <div :class="`__wrapper d-flex ${view}`">
      ...
      <UISelect
        ...
        @updateValue="(val: UISelectData) => counterValue.select = val"
      />
...
<script setup lang="ts">
  ...
  const counterValue = ref({
    ...
    select: props.options?.checkedSelect || {} as UISelectData
  })
    ...
    .__wrapper {
      ...
      .el-input-number {
        ...
        span[role=button] {
          ...
          border: unset;
          border-radius: 0;
          transition: color $minTime, background-color $minTime;
