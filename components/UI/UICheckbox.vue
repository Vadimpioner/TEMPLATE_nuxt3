...
<script setup lang="ts">
  ...
  const emits = defineEmits<{
    <T extends boolean | UICheckboxData[]>(name: 'updateValue', val: T): void
  }>()
  ...
  const checkboxGroup = ref<UICheckboxData[]>([])
