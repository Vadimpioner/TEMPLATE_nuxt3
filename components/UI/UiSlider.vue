<template>
  <div :class="[`UiSlider__${view} w100 h100 d-flex`]">
    <Swiper
      v-bind="{
        slidesPerView: 'auto',
        speed: 800,
      ...
      .swiper {
        ...
        &-pagination {
          span {
            ...
            transition: transform $minTime, background-color $minTime !important;
          }
        ...
        &-button {
          &-next, &-prev {
            transition: opacity $minTime, border-color $minTime, background-color $minTime, color $minTime;
