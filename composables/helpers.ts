...
export function useHelpers(){
  ...
  function validationForm<T extends Partial<_globalFormData>>(ID: string, formD: T, skipKeys?: (keyof T)[]) {
    ...
    const INFO: {
        name: UIInputOptions,
        phone: UIInputOptions,
        textarea: UIInputOptions,
        password: UIInputOptions,
        passwordRepeat: UIInputOptions,
        email: UIInputOptions,
        checkbox: UICheckboxOptions,
        checkboxMultiple: UICheckboxOptions,
        select: UISelectOptions,
        selectMultiple: UISelectOptions,
        time: UIInputOptions,
        date: UIInputOptions,
        dateTimeLocal: UIInputOptions,
        file: UIUploadOptions,
        fileMultiple: UIUploadOptions,
      } = {
      name: {
        label: 'Имя',
        placeholder: 'Имя',
